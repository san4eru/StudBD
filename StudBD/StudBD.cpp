...
// StudBD.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CStudBDApp, CWinApp)
...
// Единственный объект CStudBDApp

CStudBDApp theApp;


// Инициализация CStudBDApp

BOOL CStudBDApp::InitInstance()
{
